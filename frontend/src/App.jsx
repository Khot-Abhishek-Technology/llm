...
import StudentTechPractice from "./pages/StudentTechPractice";
import StudentSuggestedQuestions from "./pages/StudentSuggestedQuestions";
  ...
  return (
    <Router>
      <Routes>
        ...
        <Route path="/student-tech" element={<StudentTechPractice />} />
        <Route path="/student-suggested" element={<StudentSuggestedQuestions />} />
      </Routes>
    </Router>
  );
};
